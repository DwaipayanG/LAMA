export default function Starlight() {
    ...
    */
    let locLeft = Math.random() * window.innerWidth; //to get a random left position of star
    let locTop = Math.random() * window.innerHeight; //to get a ranodme right position of star
